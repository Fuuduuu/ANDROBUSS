...
27. PASS 20B - GTFS_PIPELINE_DOCS_AND_DIAGRAMS_SYNC (docs-only): current

Next pass:

28. PASS 21 - FEED_DOMAIN_SNAPSHOT_AND_ROUTE_PATTERN_PROVIDER_SPEC

Likely following passes:

29. PASS 22 - VERIFIED_STOPPOINT_SELECTION_AND_BRIDGE_WIRING_STRATEGY
30. PASS 23+ - ROOM/CACHE BASELINE (only after provider boundary is stable)
31. PASS UI-01 - DESTINATION_FIRST_HOME_AND_RESULT_CARDS_IMPLEMENTATION (after production feed/provider/query path is stable)
