...
19. PASS UX-01 - UX_BLUEPRINT_AND_MVP_SCOPE_SYNC (docs-only): current

Next pass:

20. PASS 16 - STOP_CANDIDATE_ENRICHMENT_AND_BRIDGE_WIRING_PRODUCTION

Likely following passes:

21. PASS 17 - VERIFIED_STOPPOINT_CANDIDATE_MODEL_AND_MAPPING_STRATEGY
22. PASS 18 - RAKVERE_STOPPOINT_MAPPING_FIXTURE_SPEC
23. PASS UI-01 - DESTINATION_FIRST_HOME_AND_RESULT_CARDS_IMPLEMENTATION (must follow UX blueprint and proven core query path)
