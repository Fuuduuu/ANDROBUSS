...
30. PASS 22B - FEED_CONTRACT_MOVE_AND_ROOM_SCHEMA_WITH_SCOPED_KEYS: current candidate

Next pass:

31. PASS 23 - FEED_SNAPSHOT_IMPORT_OR_APP_WIRING_DECISION

Likely following passes:

32. PASS 24 - VERIFIED_STOPPOINT_SELECTION_AND_BRIDGE_WIRING_STRATEGY
33. PASS 25+ - RUNTIME FEED IMPORT + CACHE LIFECYCLE (after provider boundary and wiring decision are stable)
34. PASS UI-01 - DESTINATION_FIRST_HOME_AND_RESULT_CARDS_IMPLEMENTATION (after production feed/provider/query path is stable)
