...
20. PASS 16 - STOP_CANDIDATE_ENRICHMENT_PRODUCTION: current

Next pass:

21. PASS 17 - RAKVERE_STOPPOINT_MAPPING_FIXTURE_SPEC

Likely following passes:

22. PASS 18 - VERIFIED_STOPPOINT_CANDIDATE_MODEL_AND_MAPPING_STRATEGY
23. PASS 19 - STOPPOINT_SELECTION_POLICY_FOR_BRIDGE_WIRING
24. PASS UI-01 - DESTINATION_FIRST_HOME_AND_RESULT_CARDS_IMPLEMENTATION (must follow UX blueprint and proven core query path)
