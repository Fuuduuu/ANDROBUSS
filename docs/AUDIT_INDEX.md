...
| PASS 31 / current | Rakvere quick destinations UI only | `docs/audit/PASS_31_RAKVERE_QUICK_DESTINATIONS_UI_ONLY.md` | current candidate | Need quick chips wired to existing destination resolver flow (label/queryText only, no StopPointId shortcuts) |
