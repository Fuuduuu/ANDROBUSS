...
| PASS FEED-01 / current | Feed freshness and update architecture docs-only decision | `docs/audit/PASS_FEED_01_FEED_FRESHNESS_AND_UPDATE_ARCHITECTURE_DOCS.md` | current candidate | Need freshness policy, metadata model, activation/swap policy, and FEED-02/03/04 sequencing before implementation |
