...
| PASS AUTO-05 / current | Extend Detekt boundary-only coverage to app/data-local/feature-search/city-adapters | `docs/audit/PASS_AUTO_05_EXTEND_DETEKT_BOUNDARY_COVERAGE.md` | current candidate | Need wider module-boundary static guardrails before broader UI/runtime expansion |
