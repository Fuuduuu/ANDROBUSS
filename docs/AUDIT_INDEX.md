...
| PASS UI-02 / current | Search screen flow polish (UI/copy/state only) | `docs/audit/PASS_UI_02_SEARCH_SCREEN_FLOW_POLISH.md` | current candidate | Need stale destination gating, origin clutter reduction, and rider-facing wording polish without ViewModel/domain/data/runtime changes |
