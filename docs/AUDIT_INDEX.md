...
| PASS AUTO-06 / current | Drift and UI baseline boundary check after PASS 28C | `docs/audit/PASS_AUTO_06_DRIFT_AND_UI_BASELINE_CHECK.md` | current candidate | Need governance/state sync and boundary verification before further UI scope expansion |
