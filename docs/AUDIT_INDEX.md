...
| PASS 28C / current | First app Compose search screen baseline | `docs/audit/PASS_28C_COMPOSE_SEARCH_SCREEN_BASELINE.md` | current candidate | Need first user-facing search screen without opening navigation/GPS/network/realtime scope |
