...
| PASS UI-01 / current | Search screen smoke and wording polish | `docs/audit/PASS_UI_01_SEARCH_SCREEN_SMOKE_AND_POLISH.md` | current candidate | Need first-screen UX hardening without expanding feature scope |
