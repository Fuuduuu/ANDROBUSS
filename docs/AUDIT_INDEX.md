...
| PASS FEED-02 / current | Room schema export and feed metadata entity foundation | `docs/audit/PASS_FEED_02_ROOM_SCHEMA_EXPORT_AND_FEED_METADATA_ENTITY.md` | current candidate | Need Room v2 metadata table + migration + schema export before downloader pipeline work |
