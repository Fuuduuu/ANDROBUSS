...
| PASS AUTO-04 / current | Bootstrap Room-first cold-start hardening | `docs/audit/PASS_AUTO_04_BOOTSTRAP_ROOM_FIRST_CHECK.md` | current candidate | Need cache->Room->asset fallback lifecycle confirmation before Compose scope opening |
