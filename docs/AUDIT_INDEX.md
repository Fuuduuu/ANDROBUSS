...
| PASS 32 / current | Origin picker from runtime stops (group-aware) | `docs/audit/PASS_32_ORIGIN_PICKER_FROM_RUNTIME_STOPS_GROUP_AWARE.md` | current candidate | Need runtime-backed origin options without synthetic IDs and without GPS/network scope expansion |
