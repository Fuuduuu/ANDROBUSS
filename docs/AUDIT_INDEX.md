...
| PASS 30 / current | Real Rakvere static runtime profile baseline | `docs/audit/PASS_30_REAL_RAKVERE_STATIC_RUNTIME_PROFILE_BASELINE.md` | current candidate | Need runtime primary real-static asset + synthetic fallback behavior with attribution and no downloader/freshness overclaim |
