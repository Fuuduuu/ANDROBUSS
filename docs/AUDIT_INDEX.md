...
| PASS 29C / current | Real runtime feed policy before quick destinations | `docs/audit/PASS_29C_REAL_RUNTIME_FEED_POLICY_BEFORE_QUICK_DESTINATIONS.md` | current candidate | Need explicit unblock policy tying quick labels to active runtime snapshot identity + legal/freshness constraints |
