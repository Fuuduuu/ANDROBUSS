...
| PASS 29A / current | Rakvere quick destination resolution readiness | `docs/audit/PASS_29A_RAKVERE_QUICK_DESTINATION_RESOLUTION_READINESS.md` | current candidate | Need evidence whether proposed quick labels resolve through active runtime destination flow |
